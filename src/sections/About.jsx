...
export default function About() {
  return (
    <section id="about" className="py-12 md:py-20 px-4 sm:px-8 max-w-5xl mx-auto">
      <Reveal>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-start">
          ...
          {/* Lado Esquerdo: Info e Mini-cards */}
          <div className="space-y-6 md:space-y-8">
            ...
            {/* Grid de mini-cards */}
            <div className="md:pb-0 grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
            ...
            {/* Botão de Contato - Mobile Friendly */}
            <div className="pt-2 md:pt-0">
              <a 
                href="https://wa.me/5585999525960"
                target="_blank" 
                rel="noopener noreferrer"
                className="w-full sm:w-max px-8 py-4 border-2 border-green-500/50 text-green-400 rounded-lg hover:bg-green-500/10 hover:border-green-500 transition-all font-mono font-bold flex items-center justify-center gap-2 text-sm md:text-base"
              >
                Say Hi_
              </a>
            </div>
          ...
          <div className="bg-slate-900/30 border border-slate-800 p-6 md:p-8 rounded-2xl relative overflow-hidden group">
            ...
            <ul className="space-y-5 font-mono text-xs sm:text-sm">
              <li className="flex flex-col sm:flex-row sm:justify-between sm:items-center border-b border-slate-800 pb-3 gap-1">
                <span className="text-slate-500 uppercase tracking-wider text-[10px]">Languages</span>
                <span className="text-blue-400">C++, Python, Javascript</span>
              </li>
              <li className="flex flex-col sm:flex-row sm:justify-between sm:items-center border-b border-slate-800 pb-3 gap-1">
                <span className="text-slate-500 uppercase tracking-wider text-[10px]">Frontend</span>
                <span className="text-blue-400">React, Tailwind</span>
              </li>
              <li className="flex flex-col sm:flex-row sm:justify-between sm:items-center border-b border-slate-800 pb-3 gap-1">
                <span className="text-slate-500 uppercase tracking-wider text-[10px]">Backend</span>
                <span className="text-blue-400">Node.js, MongoDB, SQL</span>
              </li>
              <li className="flex flex-col sm:flex-row sm:justify-between sm:items-center border-b border-slate-800 pb-3 gap-1">
                <span className="text-slate-500 uppercase tracking-wider text-[10px]">Hardware</span>
